            ...
            <div className="container ">
                <div className="row">
                    <div className="col-12 col-md-4 text-center ccard">
                        <img src="assets/images/icons/icon-one-op.svg" alt="Open English logo" />
                    ...
                    <div className="col-12 col-md-4 central text-center ccard">
                        <img src="assets/images/icons/icon-three-op.svg" alt="Open English logo" />
                        <h3>Headline for icon number two</h3>
                        <p>Text below icon two, text below <b>icon two</b></p>
                    </div>

                    <div className="col-12 col-md-4 text-center ccard">
                        <img src="assets/images/icons/icon-two-op.svg" alt="Open English logo" />
